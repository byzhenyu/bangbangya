            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-title  am-cf">文章分类列表</div>
                    ...
                    <div class="widget-body  am-fr">
                            ...
                            <div class="am-form-group">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a type="button" class="am-btn am-btn-default am-btn-success" href="<?php echo U('ArticleCategory/editArticleCategory');?>"><span class="am-icon-plus"></span> 新增</a>
                        ...
                        <form action="/index.php/Admin/ArticleCategory/listArticleCategory" method="get">
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-4">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    ...
                                    <span class="am-input-group-btn">
                                        ...
                                        <a class="am-btn  am-btn-default am-btn-danger tpl-table-list-field am-icon-refresh" type="button" href="/index.php/Admin/ArticleCategory/listArticleCategory"></a>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="am-u-sm-12">
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                ...
                                <tbody>
                                    <?php if(is_array($catlist)): foreach($catlist as $key=>$v): ?><tr class="gradeX">
                                            <td><input class="ids" type="checkbox" name="chkbId" value="<?php echo ($v['article_cat_id']); ?>"></td>
                                            <td><?php echo ($v['article_cat_id']); ?></td>
                                            ...
                                            <td class="f-14">
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?php echo U('ArticleCategory/editArticleCategory',array('article_cat_id'=>$v['article_cat_id']));?>">
                                                        <i class="am-icon-pencil"></i> 编辑
                                                    </a>
                                                    <a href="javascript:void(0)" onclick="javascript:recycle(<?php echo ($v['article_cat_id']); ?>, '确认删除?!此步骤无法恢复!', true)" class="tpl-table-black-operation-del">
                            ...
                            <?php if(empty($catlist)): ?><h4>aOh! 没有相关内容!</h4><?php endif; ?>
                        </div>
                    </div>
                </div>
            </div>
