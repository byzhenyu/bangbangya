...
<body>
            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-title  am-cf"><?php echo ($type == 0? '常见问题':'使用帮助'); ?>列表</div>
                    ...
                    <div class="widget-body  am-fr">
                            ...
                            <div class="am-form-group">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a type="button" class="am-btn am-btn-default am-btn-success" href="<?php echo U('Help/editQuestion',array('type' => $type));?>"><span class="am-icon-plus"></span> 新增</a>
                        ...
                        <form action="/index.php/Admin/Help/helpList" method="get">
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    ...
                                    <span class="am-input-group-btn">
                                        ...
                                        <a class="am-btn  am-btn-default am-btn-danger tpl-table-list-field am-icon-refresh" type="button" href="/index.php/Admin/Help/helpList"></a>
                                    </span>
                                </div>
                            </div>
                            ...
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                ...
                                <tbody>
                                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr class="gradeX">
                                            ...
                                            <td class="center"><?php echo show_disabled($v['status']);?></td>
                                            <td class="f-14">
                                                <div class="tpl-table-black-operation">
                                                    <?php if($v['status'] == 1): ?><a title="点击禁用" href="javascript:void(0)" class="tpl-table-black-operation-del" onclick="changeStatus(<?php echo ($v['id']); ?>);">
                                                                禁用
                                                            </a>
                                                        <?php else: ?>                                                   
                                                            <a title="点击启用" href="javascript:void(0)" onclick="changeStatus(<?php echo ($v['id']); ?>);">
                                                            启用
                                                           </a><?php endif; ?>
                                                    </if>
                                                    <a href="<?php echo U('Help/editQuestion',array('id'=>$v['id']));?>">
    ...
    <script type="text/javascript">
        function changeStatus(id){
            $.ajax({
                url : "<?php echo U('Help/changeStatus');?>",
                type : "POST",
                dataType : "json",
                data : {
                    "id" : id,
