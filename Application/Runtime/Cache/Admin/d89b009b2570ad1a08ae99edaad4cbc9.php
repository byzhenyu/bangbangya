                            ...
                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                <div class="am-form-group tpl-table-list-select">
                                    <select data-am-selected="{searchBox: 1}" name="article_cat_id" id="article_cat_id">
                                        ...
                                        <?php if(is_array($catlist)): foreach($catlist as $key=>$v): ?><option value="<?php echo ($v['article_cat_id']); ?>"><?php echo ($v['cat_name']); ?></option><?php endforeach; endif; ?>
                                    </select>
                                    ...
                                    <?php if(is_array($articlelist)): foreach($articlelist as $key=>$v): ?><tr class="gradeX">
                                            ...
                                            <td class="f-14">
                                                <div class="tpl-table-black-operation">
                                                    ...
                                                    <?php if($v['article_id'] > 5): ?><a href="javascript:void(0)" onclick="javascript:recycle(<?php echo ($v['article_id']); ?>, '确认删除?!此步骤无法恢复!', true)" class="tpl-table-black-operation-del">
