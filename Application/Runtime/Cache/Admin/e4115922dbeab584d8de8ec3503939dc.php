            ...
            <form class="am-form" method="post">
                <fieldset>
                    ...
                    <div class="am-form-group">
                        <input type="text" name="table_name" value="<?php echo I('table_name');?>" placeholder="请输入表名">
                    </div>
                    <div class="am-form-group">
                        <label class="am-checkbox-inline">
                            <?php if(I('model')): ?><input type="checkbox" name="model" value="1" checked> Model
                                <?php else: ?>
                                <input type="checkbox" name="model" value="1"> Model<?php endif; ?>
                        </label>
                        <label class="am-checkbox-inline">
                            <?php if(I('view')): ?><input type="checkbox" name="view" value="1" checked> View
                                <?php else: ?>
                                <input type="checkbox" name="view" value="1"> View<?php endif; ?>
                        </label>
                        <label class="am-checkbox-inline">
                            <?php if(I('controller')): ?><input type="checkbox" name="controller" value="1" checked> Controller
                                <?php else: ?>
                                <input type="checkbox" name="controller" value="1"> Controller<?php endif; ?>
                        </label>
                    </div>
                    <p><button type="submit" class="am-btn am-btn-default">生成</button></p>
                    <p><?php echo ($info); ?></p>
                </fieldset>
            </form>
        </div>
