            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    ...
                    <div class="widget-body  am-fr">
                            ...
                            <div class="am-form-group">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a type="button" class="am-btn am-btn-default am-btn-success" href="<?php echo U('Shop/shopDetail');?>"><span class="am-icon-plus"></span> 新增</a>
                        ...
                        <form action="/index.php/Admin/Shop/shopList" method="get">
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    ...
                                    <span class="am-input-group-btn">
                                        ...
                                        <a class="am-btn  am-btn-default am-btn-danger tpl-table-list-field am-icon-refresh" type="button" href="/index.php/Admin/Shop/shopList"></a>
                                    </span>
                                </div>
                            </div>
                            ...
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                ...
                                <tbody>
                                    <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr class="gradeX">
                                            ...
                                            <td ><?php echo ($v['shop_type']); ?></td>
                                            <td class="center"><?php echo time_format($v['top_time']);?></td>
                                            <td class="center"><?php echo time_format($v['partner_time']);?></td>
                                            <td class="center"><?php echo time_format($v['add_time']);?></td>
                                            <td class="center"><?php echo show_dispaly($v['status']);?></td>
                                            <td class="f-14">
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?php echo U('Shop/shopDetail',array('id'=>$v['id']));?>">
                                                        <i class="am-icon-pencil"></i> 编辑
                                                    </a>
                                                 <?php if($v['status'] == 0): ?><a title="点击启用" href="javascript:void(0)" onclick="changeDisabled(<?php echo ($v['user_id']); ?>);">
                                                            启用
                                                        </a><?php endif; ?>
                                                    <?php if($v['status'] == 1): if($v['is_used'] == 0): ?><a title="点击禁用" href="javascript:void(0)" class="tpl-table-black-operation-del" onclick="changeDisabled('<?php echo ($v["user_id"]); ?>');">
                                                                禁用
                                                            </a>
