                            ...
                            <div class="am-form-group">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a type="button" class="am-btn am-btn-default am-btn-success" href="<?php echo U('Role/editRole');?>"><span class="am-icon-plus"></span> 新增</a>
                            ...
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                ...
                                <tbody>
                                    <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="gradeX">
                                            ...
                                            <td><?php echo ($v['id']); ?></td>
                                            <td style="text-align:left;"><?php echo ($v['role_name']); ?></td>
                                            <td class="left" width="50%">
                                                <?php if(!empty($v['pri_name'])): echo ($v['pri_name']); ?>
                                                <?php else: ?>
                                                    无可分配的权限<?php endif; ?>
                                            </td>
                                            <td class="left"><?php echo ($v['admin_name']); ?></td>

                                            <td class="f-14">
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?php echo U('Role/editRole',array('id'=>$v['id']));?>">
