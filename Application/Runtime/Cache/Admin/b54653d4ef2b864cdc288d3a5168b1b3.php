                ...
                <div class="widget am-cf">
                  <div class="widget-head am-cf">
                    ...
                    <div class="widget-body  am-fr">
                        ...
                        <form action="/index.php/Admin/Complaint/listComplaint" method="get">
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    <input type="text" class="am-form-field" name="keyword" placeholder="请输入任务ID或投诉人ID" value="<?php echo ($keyword); ?>">
                            ...
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="5%">ID</th>
                                        <th width="5%" class="align-center">审核状态</th>
                                        <th width="5%" class="align-center">信息状态</th>
                                        <th width="10%" class="align-center">处理时间</th>
                                        <th width="30%">操作</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if(is_array($list)): foreach($list as $k=>$v): ?><tr class="gradeX">
                                            <td><input value="<?php echo ($v['id']); ?>" class="ids" type="checkbox" name="chkbId"></td>
                                            <td><?php echo ($v['id']); ?></td>
                                            <td class="align-center"><?php echo showAuditStatus($v['audit_status']);?></td>
                                            <td class="align-center">
                                                <?php echo showChangeStatus($v['status'],$v['status'] == 1?'正常':'删除');?>
                                            </td>
                                            <td class="align-center"><?php echo time_format($v['add_time'], 'Y-m-d H:i:s');?></td>
                                            <td class="f-14">
                                                <div class="tpl-table-black-operation">
                                                    <a href="<?php echo U('ComplaintDetail',array('id'=>$v['id']));?>">
                                                        <i class="am-icon-desktop"></i> 详情
                                                    </a>
                                                    <a href="javascript:void(0)" onclick="javascript:recycle(<?php echo ($v['id']); ?>, '确认删除?!')" class="tpl-table-black-operation-del">
