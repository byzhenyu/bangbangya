			...
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				<div class="widget am-cf">
					<div class="widget-head am-cf">
						<div class="widget-title am-cf">任务类型列表</div>
					</div>
					<div class="widget-body am-fr">
								...
								<div class="am-btn-toolbar">
									<div class="am-btn-group am-btn-group-xs">
										<a type="button" class="am-btn am-btn-default am-btn-success"
										   href="<?php echo U('TaskCategory/editTaskCategory');?>">
					 ...
					 <form action="/index.php/Admin/TaskCategory/listTaskCategory" method="get">
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    <input type="text" class="am-form-field" name="keyword" placeholder="请输入名称关键字" value="<?php echo ($keyword); ?>">
						...
						<div class="am-u-sm-12">
							<table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black">
								...
								<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr class="gradeX">
										...
										<td><img src="<?php echo ($v['category_img']); ?>" width="40"></td>
										<td class="f-14">
											<div class="tpl-table-black-operation">
												<a href="<?php echo U('TaskCategory/editTaskCategory', array('id' => $v['id']));?>">
													<i class="am-icon-pencil"></i> 编辑
												</a>
												<a href="javascript:void(0);"
												   onclick="javascript:recycle(<?php echo ($v['id']); ?>, '确认删除?!此步骤无法恢复!')"
