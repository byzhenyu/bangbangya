           ...
           <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-title am-fl"><?php echo ($Info['id'] ? '编辑' : '添加'); echo ($type == 0? '常见问题':'使用帮助'); ?></div>
                    </div>
                    <div class="widget-body am-fr">

                        <form action="/index.php/Admin/Help/editQuestion" method="post" class="ajaxForm am-form tpl-form-border-form tpl-form-border-br">
                            <div class="am-form-group">
                                <label for="title" class="am-u-sm-2 am-form-label">
                                    问题标题 <span class="tpl-form-line-small-title must-input">*</span>
                                </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" id="title" name="title" placeholder="请输入标题文字"  value="<?php echo ($Info['title']); ?>">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <script id="content1" name="content" type="text/plain"><?php echo (htmlspecialchars_decode($Info["content"])); ?></script>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <div class="row">
                                        <div class="am-u-sm-3">
                                            <input type="text" placeholder="从小到大排序" id="sort" name="sort" value="<?php echo ((isset($Info['sort']) && ($Info['sort'] !== ""))?($Info['sort']):11); ?>">
                                            <small>请输入整数类型</small>
                                        </div>
                                ...
                                <div class="am-u-sm-10">
                                    <div class="am-form-group">
                                        <label class="am-radio-inline">
                                            <input type="radio" name="status" id="display" value="1"  data-am-ucheck> 显示
                                        </label>
                                        <label class="am-radio-inline">
                                            <input type="radio" name="status" id="hide" value="0" data-am-ucheck> 隐藏
                                        </label>
                                    </div>
                                    <?php if($Info['status'] == 1 or empty($Info) ): ?><script>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2">
                                    ...
                                    <input type="hidden" name="type" value="<?php if(!empty($Info)) { echo $Info['type']; }else{ echo $_GET['type']; } ?>">
