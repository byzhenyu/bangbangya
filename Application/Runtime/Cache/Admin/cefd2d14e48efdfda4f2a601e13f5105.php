            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-title am-fl"><?php echo ($info['id'] ? '编辑' : '添加'); ?>轮播图</div>
                    </div>
                    <div class="widget-body am-fr">
                        <form action="/index.php/Admin/Banner/editBanner" method="post" class="ajaxForm am-form tpl-form-border-form tpl-form-border-br">
                                        ...
                                        <div class="am-u-sm-4">
                                            <div class="am-form-group am-form-file">
                                                <div class="tpl-form-file-img">
                                                    <img src="<?php echo ($info['img_url']); ?>" alt="" style="min-height:122px; width: 122px;" id="img_">
                                                </div>
                                                <input type="hidden" value="<?php echo ($info['img_url']); ?>" name="img_url" id="img" />
                         ...
                         <div class="am-form-group">
                                ...
                                <div class="am-u-sm-7 am-u-sm-pull-2">
                                    <input type="text"  name="jump_url" value="<?php echo ($info['jump_url']); ?>"
                                           placeholder="请输入 http  https"  >
                                    <small>链接地址, 以http或https开头的网页地址</small>
                                </div>
                            </div>
                         <div class="am-form-group">
                                <label  class="am-u-sm-3 am-form-label">
