    ...
    <div class="am-g tpl-g">
        ...
        <header>
            ...
            <div class="am-fl tpl-header-logo">
                <a href="javascript:;"><img src="/Static/images/admin_logo.png"></a>
            </div>
            <!-- 右侧内容 -->
                ...
                <div class="am-fr tpl-header-navbar">
                    <ul>
                        <li class="am-text-sm tpl-header-navbar-welcome">
                            <a href="<?php echo U('Index/welcome');?>" target="mainIframe" class="link-btn">后台首页 </a>
                        </li>
        ...
        <div class="tpl-content-wrapper">
            <iframe src="" name="mainIframe" id="mainIframe" style="height:100%; width:100%; border: 0px;" frameborder="0"></iframe>
        </div>
    </div>
