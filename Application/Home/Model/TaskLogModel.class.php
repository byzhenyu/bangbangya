...
class TaskLogModel extends  Model{
    ...
    */
    public function  getTaskLogDetail($where = [], $field = null) {
        if(is_null($field)) $field = 'l.*, t.category_id, t.remark,t.title, t.link_url,t.validate_words,t.end_time, c.category_name,t.user_id as task_user_id, u.head_pic,u.nick_name,s.shop_accounts,s.top_time,s.shop_type,s.partner_time';
