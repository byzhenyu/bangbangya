...
class ComplaintController extends CommonController{
    ...
    */
    ...
    public function appeal(){
        ...
        $complaintInfo = $this->Complaint->where('user_id ='.$data['user_id'].' and  be_user_id = '.$taskInfo['user_id'].' and task_id = '.$data['task_id'].$taskLogInfo['task_id'].' and audit_status = 0')->find();
        if(!$complaintInfo){
